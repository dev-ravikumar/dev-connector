...
const Editprofile = ({history}) => {
   ...
   const dispatch = useDispatch();
    ...
    const [socialMediaLinks, toggleLinks] = useState(false);
   ...
   const onSubmit = e =>{
    ...
    return (
      ...
      <form className="form" onSubmit={e => onSubmit(e)}>
        ...
        <div className="my-2">
          <button type="button" className="btn btn-light" onClick ={() =>toggleLinks(!socialMediaLinks)} >
            Add Social Network Links
          </button>
          <span>Optional</span>
        </div>
        { socialMediaLinks &&   <Fragment>
